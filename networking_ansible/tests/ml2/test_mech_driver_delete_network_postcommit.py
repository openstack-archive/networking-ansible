...
class TestMechDriverDeleteNetworkPostCommit(AnsibleNetworkingTestCase):
    def setUp(self):
        super(TestMechDriverDeleteNetworkPostCommit, self).setUp()
        self.testhost = 'testhost'
        self.test_seg_id = '37'

    def test_delete_network_postcommit(self, mock_run_task):
        ...
        self.mech.delete_network_postcommit(mock_context)
        mock_run_task.assert_called_once_with('delete_network',
                                              self.testhost,
                                              self.test_seg_id)

    def test_delete_network_postcommit_fails(self, mock_run_task):
    ...
    def test_delete_network_postcommit_not_vlan(self, mock_run_task):
        self.mech.initialize()
        self.mech.inventory = {'all': {'hosts': {self.testhost: {}}}}
    ...
    def test_delete_network_postcommit_not_segmentation_id(self, mock_run_task):
        self.mech.initialize()
        self.mech.inventory = {'all': {'hosts': {self.testhost: {}}}}
